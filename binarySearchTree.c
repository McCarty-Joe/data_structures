...
int main(int argc, char *argv[]){
   ...
   /*After implementing your code, please uncommnet the following calls to the test functions and test your code*/
	...
	printf("AddNode finished ... Starting ContainsBSTree\n");
   
	testContainsBSTree();

	printf("Contains finished ... starting leftmost\n");
    
	testLeftMost();

	printf("leftmost finished ... starting remove leftmost\n");
    	testRemoveLeftMost();

	printf("removeleftmost finished ... starting removeNode\n");
	testRemoveNode();
